...
<body>
                ...
                @if ($user)
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="{{ route('judge.swim_suit_table') }}">Swimsuit</a></li>
                            @endif
                        </ul>
                    </li>
                    @endif
    ...
    <div class="content">
        <div class="container">
            ...
            <br>
            <h2 class="swimsuit">Swimsuit Score Sheet</h2>
            <br>
            
            <!-- Swim Suit Form -->
            <div id="swim_suit_table" class="category-table-swim-suit">
                        ...
                        <tbody id="swim_suit_table_body">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    value="{{ $submittedScores[$candidate->candidateNumber]['composure'] ?? '' }}" 
    ...
    <script>
        ...
        // Call calculateTotalScore for initial calculation in swim-suit category
